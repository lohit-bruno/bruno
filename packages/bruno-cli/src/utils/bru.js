...
const { bruToEnvJsonV2, bruToJsonV2, collectionBruToJson: _collectionBruToJson, bruToJsonParsimmon: _bruToJsonParsimmon } = require('@usebruno/lang');
 ...
 * @returns {object} The JSON representation of the BRU file.
 */
const bruToJsonParsimmon = (bru) => {
  try {
    const json = _bruToJsonParsimmon(bru);
