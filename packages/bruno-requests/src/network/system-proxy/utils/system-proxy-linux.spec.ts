import { LinuxProxyDetector } from './linux';
...
describe('LinuxProxyDetector', () => {
  ...
  describe('gsettings proxy detection', () => {
    ...
    it('should handle non-manual proxy mode', async () => {
      ...
      mockExec.mockResolvedValueOnce({ stdout: modeOutput, stderr: '' });
