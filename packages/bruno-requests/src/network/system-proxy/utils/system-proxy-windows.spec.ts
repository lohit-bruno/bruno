import { WindowsProxyDetector } from './windows';
...
describe('WindowsProxyDetector', () => {
  let detector: WindowsProxyDetector;
  let mockExec: jest.MockedFunction<any>;

  beforeEach(() => {
    detector = new WindowsProxyDetector();
...
`;
      ...
      mockExec.mockResolvedValueOnce({ stdout: regOutput, stderr: '' });
