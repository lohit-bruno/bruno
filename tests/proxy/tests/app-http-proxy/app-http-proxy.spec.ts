...
test.describe('App-level HTTP proxy (collection inherits)', () => {
  test('all requests pass through inherited HTTP proxy', async ({ pageWithUserData: page }) => {
    ...
    // Verify proxy-related timeline logs — app-level HTTP proxy should be inherited
